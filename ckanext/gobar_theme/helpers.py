...
def update_frequencies(freq_id=None):
    frequencies = [
        ("R/PT1S", "Continuosly Updated"),
        ("R/PT1H", "Hourly"),
        ("R/P1D", "Daily"),
        ("R/P0.33W", "Three times a week"),
        ("R/P0.5W", "Twice a week"),
        ("R/P3.5D", "Every midweek"),
        ("R/P1W", "Weekly"),
        ("R/P0.33M", "Three times a week"),
        ("R/P0.5M", "Every 15 days"),
        ("R/P1M", "Monthly"),
        ("R/P2M", "Bimonthly"),
        ("R/P3M", "Quaterly"),
        ("R/P4M", "Every 4 months"),
        ("R/P6M", "Every half year"),
        ("R/P1Y", "Annual"),
        ("R/P2Y", "Every two years"),
        ("R/P3Y", "Every three years"),
        ("R/P4Y", "Every four years"),
        ("R/P10Y", "Every ten years"),
        ('eventual', 'Eventual')
    ]
...
def field_types():
    return {
        ...
        "date-time": "Date and Time ISO-8601 (date-time)",
        "object": "JSON (object)",
        "geojson": "GeoJSON (geojson)",
        "geo_point": "GeoPoint (geo_point)",
        "array": "List of values in JSON (array)",
        "binary": "Binary value in base64 (binary)",
        "any": "Other (any)"
    }
